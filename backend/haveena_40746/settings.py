"""
Django settings for haveena_40746 project.
...
ROOT_URLCONF = 'haveena_40746.urls'
...
WSGI_APPLICATION = 'haveena_40746.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "haveena_40746 API",
    "DESCRIPTION": "API documentation for haveena_40746 App",
    "VERSION": "v1",
}
